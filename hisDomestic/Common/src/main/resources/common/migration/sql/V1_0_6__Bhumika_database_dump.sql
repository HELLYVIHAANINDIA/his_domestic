...
MySQL - 5.7.16-log : Database - hisdomestic1
*********************************************************************
*/
...
CREATE TABLE `tbl_appointment` (
  ...
  CONSTRAINT `FKii6vxtuxa3xm7o1abd7lxjbjd` FOREIGN KEY (`casetypeid`) REFERENCES `tbl_casetype` (`casetypeid`),
...
CREATE TABLE `tbl_category` (
  ...
  `unspscDesc` varchar(255) DEFAULT NULL,
  `unspscId` int(11) DEFAULT NULL,
  PRIMARY KEY (`categoryId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `tbl_category` */

/*Table structure for table `tbl_categorymap` */

DROP TABLE IF EXISTS `tbl_categorymap`;

CREATE TABLE `tbl_categorymap` (
  `categoryMapId` int(11) NOT NULL,
...
/*Data for the table `tbl_categorymap` */
...
CREATE TABLE `tbl_clinicaldetail` (
  ...
  CONSTRAINT `FK2pyqnjab8wus3g1i2bq3vtgan` FOREIGN KEY (`patientid`) REFERENCES `tbl_patient` (`patientid`),
...
CREATE TABLE `tbl_clinicalreports` (
  ...
  `schedualid` int(11) NOT NULL DEFAULT '0',
  `findingReport` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`clinicalreport_id`),
  KEY `patientidclinical` (`patientid`),
  CONSTRAINT `FK6hxssvdskl9xvaa38mtcabmr` FOREIGN KEY (`patientid`) REFERENCES `tbl_patient` (`patientid`),
...
CREATE TABLE `tbl_columntype` (
  ...
  UNIQUE KEY `UK_r6n6vgjirnljodvay7jf3v7dr` (`columnName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*Table structure for table `tbl_currencymap` */

DROP TABLE IF EXISTS `tbl_currencymap`;

CREATE TABLE `tbl_currencymap` (
  `currencyMapId` int(11) NOT NULL,
  `createdByDate` datetime DEFAULT NULL,
  `createdById` int(11) DEFAULT NULL,
  `currencyId` int(11) DEFAULT NULL,
  `departmentId` int(11) DEFAULT NULL,
  PRIMARY KEY (`currencyMapId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `tbl_currencymap` */
...
CREATE TABLE `tbl_finding` (
  ...
  `findingname` varchar(50) DEFAULT NULL,
  `findingstatus` int(11) DEFAULT '0',
  PRIMARY KEY (`findingid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

/*Data for the table `tbl_finding` */

insert  into `tbl_finding`(`findingid`,`findingname`,`findingstatus`) values 
...
CREATE TABLE `tbl_marquee` (
  `marqueeId` int(11) NOT NULL,
  `createdBy` int(11) DEFAULT NULL,
  `createdOn` datetime DEFAULT NULL,
  `endDate` datetime DEFAULT NULL,
  `isActive` int(11) NOT NULL,
  `marqueeText` varchar(255) NOT NULL,
  `marqueeTo` int(11) DEFAULT NULL,
  `startDate` datetime NOT NULL,
  `tenderId` int(11) DEFAULT NULL,
  `processId` int(11) DEFAULT NULL,
  PRIMARY KEY (`marqueeId`),
  KEY `FKd7r3otqpvt5br966jvgk4yvq0` (`processId`),
  CONSTRAINT `FKd7r3otqpvt5br966jvgk4yvq0` FOREIGN KEY (`processId`) REFERENCES `tbl_process` (`processId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_medicine` (
  ...
  `medicineStatus` int(11) DEFAULT '0',
  PRIMARY KEY (`medicine_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

/*Data for the table `tbl_medicine` */

insert  into `tbl_medicine`(`medicine_id`,`medicine_name`,`medicineStatus`) values 
...
(8,'Januyia XRLP(100/1000)',0),

(9,'Amryl M1 Force(1/1000)',0),
...
(18,'Azior Asp(10/25)',0),

(19,'Azior gold(10 mg)',0),

(20,'Telsite(40 mg)',0),

(21,'Telsite-H(40/12.5)',0),

(22,'Telsite(40/5)',0),

(23,'Telsite(80 mg)',0),

(24,'Telsite-AMH(40/5/12.5)',0),
...
(29,'Monit GTN(2.6 mg)',0),

(30,'Giyniy(2.6 mg)',0),

(31,'Caroace(1.25 mg)',0),

(32,'Caroace(2.25 mg)',0),

(33,'Caroace(5 mg)',0),

(34,'Tryptomer(10 mg)',0),

(35,'Tryptomer(25 mg)',0),

(36,'Esciess(5 mg)',0),

(37,'Esciess(5/0.5)',0),

(38,'Laraceb NT(400/10)',0),

(39,'Keprra(500 mg)',0),

(40,'Valgress(500 mg)',0),

(41,'Larageb at ls(100/10)',0),
...
(45,'Cap.Mozecagv(625mg)',0);

/*Table structure for table `tbl_medicineschedule` */

DROP TABLE IF EXISTS `tbl_medicineschedule`;

CREATE TABLE `tbl_medicineschedule` (
  `seduleid` int(11) NOT NULL AUTO_INCREMENT,
  `medicineschedule` text,
  `status` int(11) DEFAULT '0',
  PRIMARY KEY (`seduleid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

/*Data for the table `tbl_medicineschedule` */

insert  into `tbl_medicineschedule`(`seduleid`,`medicineschedule`,`status`) values 
...
CREATE TABLE `tbl_patient` (
  ...
  CONSTRAINT `FK773wdi7ooh0nji08ptl45pfx4` FOREIGN KEY (`consultingdoctorid`) REFERENCES `tbl_consultingdoctor` (`consultingdoctorid`),
  CONSTRAINT `FKiiyn4rlcikbbdka34br1y21eg` FOREIGN KEY (`userdetailid`) REFERENCES `tbl_user` (`userdetailid`),
...
CREATE TABLE `tbl_patientaddiction` (
  ...
  CONSTRAINT `FK9lydxc9muogwwh1f174jh3wtp` FOREIGN KEY (`addictionid`) REFERENCES `tbl_addiction` (`addictionid`),
...
CREATE TABLE `tbl_patientreference` (
  ...
  CONSTRAINT `FKf09tt4ljp7k6kvaax3yvoot4u` FOREIGN KEY (`referencebytypeid`) REFERENCES `tbl_referencebytype` (`referencebytypeid`),
...
CREATE TABLE `tbl_process` (
  ...
  `processText` varchar(255) DEFAULT NULL,
...
insert  into `tbl_report`(`report_id`,`report_name`,`reportstatus`) values 
...
/*Data for the table `tbl_ruleviolation` */
...
CREATE TABLE `tbl_state` (
  ...
  CONSTRAINT `FKipe9g0cxx11dtyy8lcgmtw8jo` FOREIGN KEY (`countryId`) REFERENCES `tbl_country` (`countryId`),
...
CREATE TABLE `tbl_userlogin` (
  ...
  `otherdesignation` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`userId`),
  KEY `FK_tbl_userlogincasetype` (`casetypeid`),
  KEY `FK_tbl_userloginusertype` (`usertypeid`),
  KEY `FK_tbl_userlogindesign` (`designationId`),
  CONSTRAINT `FK9huxrbbofkw0vbry725eodo5v` FOREIGN KEY (`usertypeid`) REFERENCES `tbl_usertype` (`usertypeid`),
  ...
  CONSTRAINT `FKa49ebxh6lill1hfg38wcyjo0a` FOREIGN KEY (`casetypeid`) REFERENCES `tbl_casetype` (`casetypeid`),
  CONSTRAINT `FKgpunt7nv9qtw4dbhh1peuojhb` FOREIGN KEY (`designationId`) REFERENCES `tbl_designation` (`designationid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

/*Data for the table `tbl_userlogin` */

insert  into `tbl_userlogin`(`userId`,`isCTPLUser`,`failedattempt`,`loginid`,`password`,`cstatus`,`designationId`,`forgotpwdHash`,`forgotpwdExpiryDate`,`lastLogin`,`isFirstLogin`,`usertypeid`,`casetypeid`,`otherdesignation`) values 

(1,1,0,'superadmin@webstrikers.com','i3KIfuzbumRZYld9mcvu/g==',1,1,NULL,NULL,'2017-07-14 11:40:59',0,1,1,NULL);
