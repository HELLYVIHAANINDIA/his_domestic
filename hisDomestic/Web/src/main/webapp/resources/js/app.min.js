...
function _init() {
    ...
    $.AdminLTE.layout = {
        ...
        fix: function() {
            ...
            var ww = $(window).width();
                if(ww > 768){
                    var cr = $(".register-layout-left").height() + $(".main-header").outerHeight();  
                }
                          
                $("#register .register-layout-right").css("min-height", cr);
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
                ...
                if(ww > 768){
                b >= c ? ($(".login-layout").css("min-height", b - a), d = b - a) : ($(".login-layout").css("min-height", c), d = c);
                }
        ...
        $(document).off("click", a + " li a").on("click", a + " li a", function(a) {
            ...
            e.parent("li").find('i.fa-minus').removeClass("fa-minus"),
            e.parent("li").find('i.fa-fw').addClass("fa-plus") ;
                ...
                e.slideDown(c, function() {
                    ...
                    f.find("li i.fa-minus").removeClass("fa-minus"), 
                    f.find("li i.fa-fw").addClass("fa-plus"), 
                    f.find("li.active").removeClass("active"), 
                    h.addClass("active"), 
                    f.find("li.active i.fa-plus").removeClass("fa-plus"), 
                    f.find("li.active i.fa-fw").addClass("fa-minus"), 
                    b.layout.fix()
                })
            }
