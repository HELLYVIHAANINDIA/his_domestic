...
var rgx_alter_email_id = /^(((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))([\,](((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))))*\.?$/i;//alteremail
...
var rgx_alphanumspecialgrade = /^([0-9a-zA-Z\-\+\.\s\/\,]*)[a-zA-Z\-\+\.\s\,\/]+([0-9a-zA-Z\-\+\.\s\/\,]*)$/;

var rgx_alphanumspecialwithequalto = /^([0-9a-zA-Z\=\@\*\(\)\-\+\.\s\/\,'"&;:]*)[a-zA-Z\@\*\(\)\-\+\.\s\,\/\=]+([0-9a-zA-Z\=\@\*\(\)\-\+\.\s\/\,'"&;:]*)$/;
...
var rgx_keyword = /^([a-zA-Z0-9\,\s]*)[a-zA-Z\s]+([a-zA-Z0-9&\,\-\/\.\s]*)$/;
...
var rgx_alphanumwithspace =/^([0-9a-zA-Z\s]*)[a-zA-Z]+([0-9a-zA-Z\s]*)$/;

var rgx_numwithdecimal = "^\\d.*?\\.\\d{decimalUpto}$";

var rgx_posnegwithdecimal= "/^-?\d*\.?\d{0,decimalUpto}$/";

var rgx_integeronly = /^[1-9]\d*$/;

var rgx_positiveno = /^\d+$/;

var rgx_uptofivedecimal=/^\s*-?[0-9]\d*(\.\d{1,5})?\s*$/; 

var rgx_positivewithdecimal=/^[+]?([0-9]+(?:[\.][0-9]*)?|\.[0-9]+)$/;

var rgx_uptofivedecimalsecond=/^\s*-?[0-9]\d{0,9}(\.\d{1,5})?\s*$/; 

var rgx_brief =/^([0-9a-zA-Z\s]*)[0-9a-zA-Z\s\-\/\.\(\)_:&\,\+]+([0-9a-zA-Z\s\-\/\.\(\)_:&\,\+\s]*)$/; 

var rgx_uptodecimal = "^\\s*-?[0-9]\\d*(\\.\\d{1,decimal})?\\s*$";

var rgx_alphanumwithspacedecimal =/^([0-9a-zA-Z\s]*)[0-9a-zA-Z]+([0-9a-zA-Z\s\.]*)$/;
...
var rgx_positivecount = "^\\d{1,count}$"; 

var rgx_txtarea =/^([0-9a-zA-Z\s]*)[0-9a-zA-Z\s\-\/\.\,]+([0-9a-zA-Z\s\-\/\.\'\&\(\)\,]*)$/;  

var rgx_address =/^([0-9a-zA-Z\s]*)[0-9a-zA-Z\s\-\/\.\,\&\:\;]+([0-9a-zA-Z\s\-\/\.\,\&\:\;]*)$/; 
...
var rgx_alphanumwithnewchar = /^([0-9a-zA-Z\s]*)[0-9a-zA-Z\+\-\.\/\(\)\s]+([0-9a-zA-Z\+\-\.\/\(\)\s]*)$/;

var rgx_alphanumwithchar = /^([0-9a-zA-Z\s]*)[0-9a-zA-Z\,\-\.\/\s]+([0-9a-zA-Z\,\-\.\/\s]*)$/;

var rgx_alphanumwithspecial = /^([0-9a-zA-Z\s]*)[0-9a-zA-Z\+\-\.\/\(\)\,\s]+([0-9a-zA-Z\+\-\.\/\(\)\,\s]*)$/;

var rgx_specialkeyword = /^([0-9a-zA-Z\s]*)[0-9a-zA-Z\@\*\+\-\.\/\(\)\,\s]+([0-9a-zA-Z\@\*\+\-\.\/\(\)\,\s]*)$/;

var rgx_specialkeywordwithnumber = /^([0-9a-zA-Z\s]*)[0-9a-zA-Z\@\*\+\-\.\/\(\)\s]+([0-9a-zA-Z\@\*\+\-\.\/\(\)\s]*)$/;

var rgx_specialkeywordwithnumber = /^([0-9a-zA-Z\s]*)[0-9a-zA-Z\s\-\/\.\(\)\+\@\*]+([0-9a-zA-Z\s\-\/\.\(\)\+\@\*]*)$/;

var rgx_alphawithspecial = /^([0-9a-zA-Z\s]*)[a-zA-Z\-\.\/\s]+([0-9a-zA-Z\-\.\/\s]*)$/; 

var rgx_alphawithsomespecial = /^([0-9a-zA-Z\s]*)[a-zA-Z\-\.\'\s]+([0-9a-zA-Z\-\.\'\s]*)$/; 

var rgx_tenderkeyword=/^([0-9a-zA-Z\s]*)[0-9a-zA-Z\s\-\/\.\(\)\+\@\*\,]+([0-9a-zA-Z\s\-\/\.\(\)\+\@\*\,]*)$/;

var rgx_commonkeyword=/^([0-9a-zA-Z\s]*)[0-9a-zA-Z\s\-\/\.\(\)\+\@\*\&\,]+([0-9a-zA-Z\s\-\/\.\(\)\+\@\*\&\,]*)$/;

var rgx_percentage = /^-?[0-9]+(\.[0-9]{1,5})?%?$|^-?(100)(\.[0]{1,5})?%?$/;

var rgx_alphanumspecialwithand = /^([0-9a-zA-Z\@\*\(\)\-\+\.\s\/\,]*)[a-zA-Z\@\*\(\)\-\+\.\s\,\/]+([0-9a-zA-Z\@\*\(\)\-\+\.\s\/\,\&]*)$/;

var rgx_alphanumspecialwithoutcomma = /^([0-9a-zA-Z\@\*\(\)\-\+\.\s\/]*)[a-zA-Z\@\*\(\)\-\+\.\s\/]+([0-9a-zA-Z\@\*\(\)\-\+\.\s\/\&]*)$/;
...
var rgx_alphanumericwithoutspace=/^[a-zA-Z0-9]*$/;  

var rgx_numericswithcomma = /^[0-9\,]*$/;

var rgx_allmoney = "^-?[0-9]+(.?[0-9]{0,5})?$";

var rgx_specialkeywordforgroupname = /^([0-9a-zA-Z\s]*)[0-9a-zA-Z\@\*\+\-\!\/\(\)\s]+([0-9a-zA-Z\@\*\+\-\!\/\(\)\s]*)$/;
    ...
    for(var i=0;i<valids.length;i++){
        ...
        if(str.indexOf(':', 0)!=-1){    
            ...
            if(str == 'length'){
                ...
                maxlen = parseInt(lenArr[1]);
            }else if(str == 'rgx_tenderkeyword'){
                maxlen = parseInt(lenArr[1]);
            }else if(str == 'rgx_specialkeyword'){
                maxlen = parseInt(lenArr[1]);
            }else if(str == 'rgx_specialkeywordwithnumber'){
            	maxlen = parseInt(lenArr[1]);
        ...
        rgx_uptodecimal="^\\s*-?[0-9]\\d*(\\.\\d{1,decimal})?\\s*$"; // Assign Actual RegExp Changes Bug Id:30211
        switch (str){
            case 'required':
                if(tbool && !compValEmpty){
                   //alert($(comp).attr('title'));
            ...
            case 'email':
                ...
                break;
            case 'alteremail':
                if(tbool && compValEmpty && !rgx_alter_email_id.test(compVal)){
                    if(notcommmsg){
            ...
            case 'emailmsgbox':
                if(tbool && compValEmpty){                                           
                    	if(!rgx_alter_email_id.test(compVal)){ /* validate email */
                			if(notcommmsg){
                        	     $(comp).parent().append("<div class='err"+compId+"' style='color:red; padding-top:5px;'>" + VALIDATE_MSG_INVALID_EMAIL_MSGBOX + "</div>");                        		
                			}
                			tbool = false;
                        }
            ...
            case 'alphanumericlength':
                ...
                if(tbool && compValEmpty && minlen!=0 && compVal.length < minlen){
                    ...
                    if(notcommmsg){
                        $(comp).parent().append("<div class='err"+compId+" validationMsg clearfix'>" + VALIDATE_MSG_MINIMUM + " " + minlen + " " + VALIDATE_MSG_NUMERICFEWALPHA + "</div>");
                    }
                    tbool = false;
                }
                ...
                if(tbool && compValEmpty && maxlen!=0 && compVal.length > maxlen){
                    ...
                    if(notcommmsg){
                        ...
                        $(comp).parent().append("<div class='err"+compId+" validationMsg clearfix'>" + VALIDATE_MSG_MAXIMUM + " " + maxlen + " " + VALIDATE_MSG_NUMERICFEWALPHA + "</div>");
                    }
                    tbool = false;
                }
            break;
                ...
                if(tbool && compValEmpty && maxlen!=0 && compVal.length > maxlen){
                  ...
                  if(tbool && compValEmpty && !rgx_positiveno.test(compVal)){
                    if(notcommmsg){
            ...
            case 'alphabet':
                ...
                break;
            case 'city':
                if(tbool && compValEmpty && !rgx_city.test(compVal)){
                    if(notcommmsg){
            ...
            case 'alphanumspecialgrade':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphanumspecialgrade.test(compVal))){
                    if(notcommmsg){
                        $(comp).parent().append("<div class='err"+compId+" validationMsg clearfix'>" + VALIDATE_MSG_ONLY_ALPHA_NUM_SPECIAL + "</div>");
                    }
                    tbool = false;
			...
			case 'alphanumspecialwithequalto':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphanumspecialwithequalto.test(compVal))){
                    if(notcommmsg){
                        $(comp).parent().append("<div class='err"+compId+" validationMsg clearfix'>" + VALIDATE_MSG_ONLY_ALPHA_NUM_SPECIAL + "</div>");
                    }
                    tbool = false;
            ...
            case 'fullname':
                ...
                break;
            case 'keyword':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_keyword.test(compVal))){
                    if(notcommmsg){
                ...
                break;
               case 'rgx_tenderkeyword':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_tenderkeyword.test(compVal))){
                    if(notcommmsg){
                        $(comp).parent().append("<div class='err"+compId+" validationMsg clearfix'>" + VALIDATE_MSG_INVALID_KEYWORD + "</div>");
                    }
                    tbool = false;
            ...
            case 'alphanumwithspace':
                if(tbool && compValEmpty && !rgx_alphanumwithspace.test(compVal)){
                    if(notcommmsg){
            ...
            case 'alphanumwithspacedecimal':
                if(tbool && compValEmpty && !rgx_alphanumwithspacedecimal.test(compVal)){
                    if(notcommmsg){
            ...
            case 'alphanumwithoutspace':
                if(tbool && compValEmpty && (!rgx_alphanumericwithoutspace.test(compVal) || compVal.length > uptodecimal)){
                	if(notcommmsg){
            ...
            case 'posnegnumwithdecimal':
                if(tbool && compValEmpty){
                    rgx_posnegwithdecimal = rgx_posnegwithdecimal.replace('decimalUpto',decimalupto);
            ...
            case 'positivecount':
                if(tbool && compValEmpty ){
                	rgx_positivecount="^\\d{1,"+uptodecimal+"}$";
                    var countRegex = new RegExp(rgx_positivecount);
            ...
            case 'uptofivedecimal':
                if(tbool && compValEmpty && !rgx_uptofivedecimal.test(compVal)){
                    if(notcommmsg){
            ...
            case 'uptofivedecimalsecond':
            	if(tbool && compValEmpty && !rgx_positivewithdecimal.test(compVal)){
                    if(notcommmsg){
                        $(comp).parent().append("<div class='err"+compId+" validationMsg clearfix'>" + VALIDATE_MSG_ONLY_POSITIVE_1 + "</div>");
                    }
                    tbool = false;
                }else if(tbool && compValEmpty && !rgx_percentage.test(compVal)){
            		 if(notcommmsg){
            	 ...
            	 else if(tbool && compValEmpty && !rgx_uptofivedecimalsecond.test(compVal)){
                ...
                break;
            case 'brief':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_brief.test(compVal))){
                    if(notcommmsg){
            ...
            case 'percentage' :
                if(tbool && compValEmpty){
                	...
                	if(uptodecimal != 0){
                		rgx_uptodecimal=rgx_uptodecimal.replace('decimal',uptodecimal);
                        decimalRegex = new RegExp(rgx_uptodecimal);
                	}
            ...
            case 'percentage1to100' :
                if(tbool && compValEmpty){
                    ...
                    if(uptodecimal != 0){
                     ...
                     if(!rgx_percentage.test(compVal)){
            ...
            case 'percentagesplit0to100' :
                ...
                break;
            case 'txtarea':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_txtarea.test(compVal))){
                    if(notcommmsg){
                ...
                break;
            case 'address':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_address.test(compVal))){
                    if(notcommmsg){
            ...
            case 'validationmessage':
                if(tbool && compValEmpty && !rgx_validatonmessage.test(compVal)){
                    if(notcommmsg){
            ...
            case 'numanduptodecimalmoneyall':
                if(tbool && compValEmpty ){
                    if(compVal!=null && compVal!= ""){
                        rgx_uptodecimal=rgx_uptodecimal.replace('decimal',uptodecimal);
                        var decimalRegex = new RegExp(rgx_uptodecimal);
                        var allMoneyRegx = new RegExp(rgx_allmoney);
                        if(compVal.indexOf('.', 0)==-1){
            ...
            break;
			case 'nospace':
				if (tbool && !rgx_nospace.test(compVal)){
					if(notcommmsg){
				...
				break;
            case 'rgx_alphanumwithnewchar':
            if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphanumwithnewchar.test(compVal))){
                if(notcommmsg){
            ...
            break;
            case 'rgx_alphanumwithchar':
            if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphanumwithchar.test(compVal))){
                if(notcommmsg){
            ...
            break;
            case 'rgx_specialkeyword':
            if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_specialkeyword.test(compVal) || maxlen<compVal.length)){
                if(notcommmsg){
            ...
            break;
            //case 'rgx_specialkeywordwithnumber':
            if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_specialkeywordwithnumber.test(compVal) )){
                if(notcommmsg){
            ...
            if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphawithspecial.test(compVal))){
                if(notcommmsg){
            ...
            break;
            case 'rgx_alphawithsomespecial':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphawithsomespecial.test(compVal))){
                if(notcommmsg){
            ...
            break;
            case 'rgx_commonkeyword':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_commonkeyword.test(compVal))){
                    if(notcommmsg){
            ...
            case 'alphanumspecialwithand':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphanumspecialwithand.test(compVal))){
                    if(notcommmsg){
                        $(comp).parent().append("<div class='err"+compId+" validationMsg clearfix'>" + VALIDATE_MSG_ONLY_ALPHA_NUM_SPECIAL + "</div>");
                    }
                    tbool = false;
            ...
            case 'alphanumspecialwithoutcomma':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphanumspecialwithoutcomma.test(compVal))){
                    if(notcommmsg){
            ...
            case 'numrericwithfewalpha':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphanumspecialwithoutcomm.test(compVal))){
                    if(notcommmsg){
                ...
                break;
            case 'rgx_alphanumwithspecial':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_alphanumwithspecial.test(compVal))){
                    if(notcommmsg){
            ...
            case 'negotiationremarks':
                ...
                break;
            case 'rgx_specialkeywordwithnumber':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_specialkeywordwithnumber.test(compVal) || maxlen<compVal.length)){
                    if(notcommmsg){
            ...
            case 'specialkeywordforgroupname':
                if(tbool && compValEmpty && (/\-{2}/.test(compVal) || !rgx_specialkeywordforgroupname.test(compVal))){
                    if(notcommmsg){
                        $(comp).parent().append("<div class='err"+compId+" validationMsg clearfix'>" + VALIDATE_MSG_ONLY_ALPHA_NUM_SPECIAL + "</div>");
                    }
                    tbool = false;
