			...
			<c:if test="${not empty successMsg}">
					...
					<div class="box-body">
							...
							<input type="hidden" name="hdUserType" value="${usertype}" />
									...
									<div class="row">
									<div class="col-lg-2">
											<div class="form_filed">Old Password<span style="color: red">*</span></div>
											
										</div>
										<div class="col-lg-5">
													<input id="txtOldPassword" class="form-control" name="txtOldPassword" validarr="required@@password@@checkloginidpwd:EmailId" tovalid="true" onblur="validateTextComponent(this)" title="Old password" type="password">
										</div>
									</div>
									
									<div class="row">
									<div class="col-lg-2">
											<div class="form_filed">New Password<span style="color: red">*</span></div>
