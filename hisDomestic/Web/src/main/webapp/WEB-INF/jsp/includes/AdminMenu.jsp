...
<li class="active">
<a href="#" onclick="changeTab(2,0,1)"> 
<i class="fa fa-user icon_desktop header-icon" aria-hidden="true"></i> 
Patient Registration
</a>
</li>

<li>
<a href="#" onclick="changeTab(3,0,1)"> 
<i class="fa fa-check-square-o icon_tags_alt header-icon" aria-hidden="true"></i> 
Appointment
</a>
</li>
