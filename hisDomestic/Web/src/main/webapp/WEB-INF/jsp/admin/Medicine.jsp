...
function deleteMedicine(medicineid) {
	 $.ajax({
		type: "POST",
		url: contextPath+"/domestic/complaints/deleteMedicine/"+medicineid,
...
<div id="masterCompaintsdiv">
	...
	<section id="content-wrapper">
		...
		<div class="site-content-title">
			<div class="col-sm-6 col-xs-12"><h2 class="float-xs-left content-title-main pull-left">Medicine</h2></div>
			...
			<div class="row">
				<div class="col-sm-12">
                     ...
                     <div class="modal fade" id="Complain" role="dialog"  style="z-index: 90">
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<div class="modal-body">
															<div class="row">
																<div class="col-xs-12">
																	<label class="lbl-1">Medicine Name </label> 
																	
												         	<input type="text" class="form-control dateBoxappointment"
															name="txtmedicine"  id="txtmedicine"
															title="Medicine Name" onblur="validateEmptyDt(this)" value="">
																</div>
															</div>
														</div>
														<div class="modal-footer">
															<button  type="button" class="btn btn-default" data-dismiss="modal" onclick="submitMedicine()">Submit</button> 
							...
							<div id="tblmedicine">
							<%@include file="../admin/MedicineTable.jsp"%>
...
function submitMedicine(){
	...
	$.ajax({
		type: "POST",
		url: contextPath+"/domestic/user/addMedicine/"+medicine,
		success: function success(result){
			$("#tblmedicine").html("");
